...
from .chinese_analyzer import chinese_analyzer
    ...
    def build_schema(self, fields):
        ...
        for field_name, field_class in fields.items():
            if field_class.is_multivalued:
                ...
                schema_fields[field_class.index_fieldname] = TEXT(stored=True, analyzer=chinese_analyzer(), field_boost=field_class.boost, sortable=True)
